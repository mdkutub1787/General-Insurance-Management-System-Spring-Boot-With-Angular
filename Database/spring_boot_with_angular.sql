...
--
-- Host: 127.0.0.1    Database: genaralinsurancemanagement
-- ------------------------------------------------------
...
INSERT INTO `bills` VALUES (42,10,12075,10500,11,15,14),(43,10,4600,4000,10,15,19),(45,12,13800,12000,12,15,2),(47,12,12650,11000,10,15,2);
...
INSERT INTO `marine_insurance_details` VALUES (1,'Jigatola Roard , Dhanmondi,Dhaka 1203','Islami   Bank PLC,Rajarbagh ,Dhaka','Lorry Risk Only','2024-11-05','M/s Towhid Enterprise  , Prop: Md. Towhid Chowdhury  ','Cosmetics and Library',23890,200,119.45,'Benapole Port','India','Dhaka'),(31,'Jigatola Roard , DhanmondiDhaka 1203','Dhaka Bank PLC,Rajarbagh ,Dhaka','Lorry Risk Only','2024-11-05','M/s Rofik  Enterprise  , Prop: Md. Rofik Chowdhury  ','Cosmetics and Library',35835,300,119.45,'Benapole Port','India','Dhaka'),(32,'lalbagh Roard , Lalabagh Dhaka 1203','Islami Bank Bangladesh PLC, Dhanmondi Branch, Dhaka','Lorry Risk Only','2024-11-08','Kacci Bhai , Prop: Md. Raju Chowdhury  ','Food',11945,100,119.45,'Benapole Port','India','Dhaka');
...
INSERT INTO `marinebillmoneyreceipts` VALUES (17,'Marine Insrurance','2024-11-08','tytutu','gft','Cheque',22),(18,'Marine Insrurance','2024-11-08','KJKJOKLM/45554','10','Cheque',28),(19,'Marine Insurance','2024-11-08','ISICL/2020110','Dhanmondi,Dhaka ','Cheque',30);
...
INSERT INTO `marineinsurancebills` VALUES (22,2848.5,10,2390,100,0.15,10,1),(28,9166.25,11,7883.7,100,15,11,31),(30,3747.35,10,2389,1000,15,10,32);
...
INSERT INTO `moneyreceipts` VALUES (4,'Marine Insurance','2024-11-07','bvnvbn','bvbvn','Bank Transfer',42),(10,'Marine Insrurance','2024-11-08','fgfhfh','dfdfg','Cheque',43),(11,'Fire Insurance','2024-11-08','ISICL/2020100','Kushtia','Bank Transfer',45);
...
CREATE TABLE `policies` (
  ...
  `period_from` varchar(255) NOT NULL,
  `period_to` varchar(255) NOT NULL,
  `policyholder` varchar(255) NOT NULL,
...
INSERT INTO `policies` VALUES (2,'Dhanmondi Roard , DhanmondiDhaka 1203','Dhaka Bank Bangladesh PLC, Baliakandi Sub-Branch, Rajbari','1st Class','Fire &/or Lightning only','2024-11-07','Food And Resturents','Dhanmondi Roard , DhanmondiDhaka 1203','The Insured','2024-11-28','2025-11-28','Kacci Bhai , Prop: Md. Raju Chowdhury  ','food Resturents',50000,'Godown Only'),(14,'Dhanmondi Roard , DhanmondiDhaka 1203','Islami Bank Bangladesh PLC, Dhaka','1st Class','Fire &/or Lightning only','2024-11-06','Food And Resturents','Dhanmondi Roard , DhanmondiDhaka 1203','The Insured','2024-11-06','2024-11-06','Towhid Bhai , Prop: Md. Towhid Chowdhury  ','food Resturents',50000,'Shop Only'),(19,'Dhanmondi Roard , DhanmondiDhaka 1203','Islami Bank Bangladesh PLC, Baliakandi Sub-Branch, Rajbari','2nd Class','Fire &/or Lightning only','2024-11-06','Food And Resturent','Dhanmondi Roard , DhanmondiDhaka 1203','The Insured','2024-11-30','2024-11-30','Kacci Bhabi , Prop: Md. Rezvi  Chowdhury  ','food Resturent',20000,'Shop-Cum-Godown only');
...
-- Dump completed on 2024-11-08 15:08:23
